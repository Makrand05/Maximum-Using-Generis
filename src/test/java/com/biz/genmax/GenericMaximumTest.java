...
public class GenericMaximumTest {
    ...
    void given3Integer_whenMax_returnCorrectMax_case1(){
       Integer actualResult= GenericMaximum.findMaximum(30,20,10);
    ...
    void given3Integer_whenMax_returnCorrectMax_case2(){
        Integer actualResult= GenericMaximum.findMaximum(30,40,10);
    ...
    void given3Integer_whenMax_returnCorrectMax_case3(){
        Integer actualResult= GenericMaximum.findMaximum(30,20,40);
        Integer expectedResult=40;
        Assert.assertEquals(expectedResult,actualResult);
    }
    @Test
    ...
    void given3Floats_whenMax_returnCorrectMax_case1(){
        Float actualResult= GenericMaximum.findMaximum(30.1f,20.2f,10.3f);
    ...
    void given3Floats_whenMax_returnCorrectMax_case2(){
        Float actualResult= GenericMaximum.findMaximum(30.1f,40.2f,10.3f);
    ...
    void given3Floats_whenMax_returnCorrectMax_case3(){
        Float actualResult= GenericMaximum.findMaximum(30.1f,20.2f,40.3f);
    ...
    void given3String_whenMax_returnCorrectMax_case1(){
        String actualResult= GenericMaximum.findMaximum("abc","PQR","XYZ");
